...
function Itinerary({ data }) {
    ...
    return (
        <>
            {data.map(itinerary => (
                <Card key={itinerary._id} className="iti-card" isHoverable variant="bordered" css={{ mw: "80%", padding: "2", backgroundColor: "white", boxShadow: "0px 5px 8px rgba(0, 0, 0, 0.505)" }}>
